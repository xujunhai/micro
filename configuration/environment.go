...
// Environment
// There is micro.properties file and application level config center configuration which higner than normal config center in java. So in java the
// configuration sequence will be config center > application level config center > micro.properties > spring bean configuration.
...
func (env *Environment) SetDynamicConfiguration(dc config.DynamicConfiguration) {
	env.dynamicConfiguration = dc
}

// GetDynamicConfiguration gets dynamicConfiguration
func (env *Environment) GetDynamicConfiguration() config.DynamicConfiguration {
